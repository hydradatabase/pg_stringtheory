...
size_t FORCE_INLINE swar64_strstr_anysize(const char *s, size_t n,
  ...
  const uint64_t first =
      0x0101010101010101llu * static_cast<uint8_t>(needle[ 0 ]);
  const uint64_t last =
      0x0101010101010101llu * static_cast<uint8_t>(needle[ k - 1 ]);

  uint64_t *block_first = reinterpret_cast<uint64_t *>(const_cast<char *>(s));
  uint64_t *block_last =
      reinterpret_cast<uint64_t *>(const_cast<char *>(s + k - 1));
...
size_t FORCE_INLINE swar64_strstr_memcmp(const char *s, size_t n,
                                         const char *needle,
                                         MEMCMP memcmp_fun) {
